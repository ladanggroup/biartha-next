                                ...
                                {companyDocument.length > 0 &&
                                    companyDocument.map((item, index) => (
                                        <ItemDocument
                                            ...
                                            <BtnDocument link={item.file_doc} />
                                        </ItemDocument>
                                    ))}
                                {companyDocument.length === 0 && (
                                    <div className="text-center text-gray-500">
                                        Belum ada dokumen perusahaan, silahkan
                                        klik tombol tambahkan dokumen.
                                    </div>
                                )}
                            </div>
                        </div>
