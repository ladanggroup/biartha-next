...
const NotFoundPage = () => (
    <>
        {/* component */}
        <div className="min-w-screen h-screen bg-blue-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
            <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
                <div className="w-full md:w-1/2">
                    <Link href={'/'}>
                        <div className="mb-10 lg:mb-20">
                            <img
                                src="/logo-text-inline.png"
                                className="block w-auto h-20"
                            />
                        </div>
                    </Link>
                    <div className="mb-10 md:mb-20 text-gray-600 font-light">
                        ...
                        <p>
                            Silahkan kembali ke halaman sebelumnya atau klik
                            tombol kembali
                        </p>
                    </div>
                    <div className="mb-20 md:mb-0">
                        <button className="text-lg flex items-center space-x-1 font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600">
                            <svg
